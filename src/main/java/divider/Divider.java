...
import divider.figure.FigureStreamer;
import divider.figure.command.CreateContourCommand;
import divider.figure.command.EditInfluenceCommand;
import divider.figure.command.RedoAction;
import divider.figure.command.UndoAction;
import divider.mesh.MeshFileFilter;
import divider.mesh.MultifileMeshStreamer;
import divider.mesh.MethodDefault;
import divider.mesh.MethodRRegular;
...
//						commandStack.doNewCommand(new EditInfluenceCommand(divider, figure));
		...
		World world;
		Figure figure;
		divider.mesh.Mesh lastMesh = null;
		MeshdownActor meshdownActor;
		divider.mesh.measure.Measure measure;
