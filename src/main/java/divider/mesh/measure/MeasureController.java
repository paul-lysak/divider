...
public class MeasureController {
	...
	{
		return divider.Divider.getDivider().getDividerUI().getMeasureFileChooser();
	}
	...
	private void createActions()
	{
		...
		AbstractAction (Messages.getString("MeasureController.Edit_Measures_1"),   //$NON-NLS-1$
				new ImageIcon(divider.Divider.class.getResource("resources/images/editMeasure.png")) //$NON-NLS-1$
				)
		{
