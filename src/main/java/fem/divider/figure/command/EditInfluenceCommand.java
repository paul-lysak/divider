...
//	public EditInfluenceCommand(divider.Divider _divider, divider.figure.Figure _fig)
	public EditInfluenceCommand(fem.divider.figure.Figure _fig)
	{
		super(_fig);
		figure=_fig;
	...
	/**
	 * @see fem.divider.command.Command#execute()
	 */
	boolean execute() {
...
//			divider.getDividerUI().getMeshPanel().redraw();
	...
	fem.divider.figure.Figure figure;
	FigureInfluenceModel modelBefore, modelAfter;

	/**
	 * @see fem.divider.command.Command#isUndoable()
	 */
...
class CGroupInfluenceModel implements Cloneable
{
	 ...
	 */
	public CGroupInfluenceModel(fem.divider.figure.CZone czone)
	{
	...
	public void applyTo(fem.divider.figure.CZone czone)
	{
...
class FigureInfluenceModel  implements Cloneable
{
	 ...
	 */
	public FigureInfluenceModel(fem.divider.figure.Figure _figure)
	{
		figure=_figure;
	...
	public Object clone()
	{
		...
		for(i=0; i<n; i++) //clone all cgroups models to new model of figure
		{
			...
			new_model.cgroups.add( (CGroupInfluenceModel)gim.clone() );			
		}
	...
	public fem.divider.figure.Figure getFigure() {return figure;}
	public List<CGroupInfluenceModel> getCGroups() {return cgroups;}
	
	private fem.divider.figure.Figure figure;
	private List<CGroupInfluenceModel> cgroups = new ArrayList<CGroupInfluenceModel>(2);
 ...
 */
class FigureInfluenceEditor extends fem.divider.AbstractEditingDialog
   {
		...
		private class InfluenceTableModel extends AbstractTableModel
		{
			...
			public Object getValueAt(int rowIndex, int columnIndex) {
				List<CGroupInfluenceModel> groups = figureInfluence.getCGroups();
