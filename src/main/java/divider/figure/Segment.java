...
//					}
	...
	Action splitSegmentAction = new AbstractAction(Messages
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (begin.contour.figure.getCommandStack().doNewCommand(
					new divider.figure.command.SplitSegmentCommand(
	...
	Action editCZonesAction = new AbstractAction(Messages
		...
		public void actionPerformed(ActionEvent event) {
			...
			if (begin.contour.figure.getCommandStack().doNewCommand(
					new divider.figure.command.EditContactZonesCommand(
							begin.contour.figure, getThisSegment()))) {
				begin.contour.figure.panel.redraw();
			}
		}
	...
	// //$NON-NLS-1$
		...
		public void actionPerformed(ActionEvent event) {
			if (begin.contour.figure.getCommandStack().doNewCommand(
					new divider.figure.command.EditSegmentGeometryCommand(
							begin.contour.figure, getThisSegment()))) {
				begin.contour.figure.panel.redraw();
			}
		}
...
class CZonesEditDialog extends divider.AbstractEditingDialog {
	CZonesEditDialog() {
